...
import { cond, enu, gender, html, insert, md, nest, plural, t } from "@intlayer/core/transpiler";
 ...
 * ```
 */
type Dictionary<T = undefined, SchemaKey extends SchemaKeys | undefined = undefined> = Dictionary$1<T, SchemaKey, true>;
/**
