...
//#region src/babel-plugin-intlayer-minify.d.ts
/**
 ...
 *   the rename map.
 */
declare const intlayerMinifyBabelPlugin: (babel: {
  types: typeof BabelTypes;
}) => PluginObj;
//#endregion
export { MinifyPluginOptions, intlayerMinifyBabelPlugin };
//# sourceMappingURL=babel-plugin-intlayer-minify.d.ts.map