...
const require_extractContent_utils_detectPackageName = require('./utils/detectPackageName.cjs');
...
const require_extractContent_extractContent = require('./extractContent.cjs');
