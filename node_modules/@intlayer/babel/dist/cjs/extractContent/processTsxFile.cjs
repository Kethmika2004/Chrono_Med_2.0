...
const processTsxFile = (filePath, componentKey, packageName, configuration, save = true, unmergedDictionaries = {}, providedFileCode) => {
	...
	const { extractedContent, replacements, componentsNeedingHooks, componentKeyMap, componentPaths, hookMap } = require_extractContent_babelProcessor.extractBabelContentForComponents(ast, fileCode, /* @__PURE__ */ new Set(), componentKey, configuration, filePath, unmergedDictionaries);
	...
	for (const componentPath of componentPaths) existingInfoCache.set(componentPath.node, require_extractContent_utils_getExistingIntlayerInfo.getExistingIntlayerInfo(componentPath));
	/**
