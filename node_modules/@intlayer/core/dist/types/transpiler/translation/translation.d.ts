...
type TranslationContent<Content = unknown, RecordContent extends StrictModeLocaleMap<Content> = StrictModeLocaleMap<Content>> = TypedNodeModel<typeof TRANSLATION, RecordContent>;
/**
 *
