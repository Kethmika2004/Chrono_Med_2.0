...
declare const RuleType: {
  ...
  readonly htmlSelfClosing: "13"; /** Custom components like <Tabs>, <TabItem> */
...
declare const Priority: {
  /** anything that must scan the tree before everything else */readonly MAX: 0; /** scans for block-level constructs */
  readonly HIGH: 1; /** inline w/ more priority than other inline */
  readonly MED: 2; /** inline elements */
  readonly LOW: 3; /** bare text and stuff that is considered leftovers */
  readonly MIN: 4;
};
