...
const startEditor = (options) => {
	...
	try {
		const child = spawnNodeProcess((0, node_path.resolve)((0, node_path.dirname)((_intlayer_config_utils.isESModule ? (0, node_module.createRequire)(require("url").pathToFileURL(__filename).href) : require).resolve("intlayer-editor/package.json")), "bin", "intlayer-editor.mjs"));
