...
const liveSync = async (options) => {
	...
	} else if (!configuration.editor.liveSync) appLogger(`Hot reload is ${(0, _intlayer_config_logger.colorize)("disabled", _intlayer_config_colors.RED)}. Please enable it in the configuration (editor.liveSync).`);
