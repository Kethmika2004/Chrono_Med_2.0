...
const startEditor = (options) => {
	...
	try {
		const child = spawnNodeProcess(resolve(dirname((isESModule ? createRequire(import.meta.url) : __require).resolve("intlayer-editor/package.json")), "bin", "intlayer-editor.mjs"));
