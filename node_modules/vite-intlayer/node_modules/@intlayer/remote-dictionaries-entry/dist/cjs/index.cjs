...
*/
const getRemoteDictionaries = (configuration = _intlayer_config_built.default) => {
	const { system, build } = configuration;
	const dictionariesPath = (0, node_path.join)(system.mainDir, `remote_dictionaries.cjs`);
	let dictionaries = {};
