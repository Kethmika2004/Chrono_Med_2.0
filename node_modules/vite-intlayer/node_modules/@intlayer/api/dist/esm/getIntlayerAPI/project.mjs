...
const getProjectAPI = (authAPIOptions = {}, intlayerConfig = config) => {
	...
	*/
	const deleteProjectByIdAdmin = async (projectId, otherOptions = {}) => fetcher(`${PROJECT_API_ROUTE}/${projectId}/admin`, authAPIOptions, otherOptions, { method: "DELETE" });
	/**
