...
export default {
  ...
  "content": {
    ...
    "translation": {
      ...
      "ta": {
        ...
        "settings": "அமைப்புகள்",
        "signOut": "வெளியேறு",
        "viewNotifications": "அறிவிப்புகளைப் பார்க்கவும்"
      },
      "hi": {
        "dashboard": "डैशबोर्ड",
  ...
  "localIds": [
    "patient-layout::local::src\\components\\layout\\PatientLayout.content.ts"
  ]
} as const;
